...
public class StmtGraph {
    ...
    public static class SignAnalysis extends ForwardFlowAnalysis<Map<LValue, SignDomain>> {
         ...
         * @param graph
         */
        public <B extends BasicBlock<B>> SignAnalysis(sootup.core.graph.StmtGraph<B> graph) {
            super(graph);
        }
    ...
    public static void main(String[] args) {
        ...
        inputLocation = new JavaSourcePathAnalysisInputLocation("src/test/resources/example/");
        ...
        ClassType classType1 = view.getIdentifierFactory().getClassType("Demo1");
        MethodSignature entryMethodSignature = view.getIdentifierFactory().getMethodSignature(classType1,
                "main", "void",
                Collections.singletonList("java.lang.String[]"));

        CallGraph callGraph = cha.initialize();
